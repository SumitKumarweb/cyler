...
const FAQ = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-black pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-1/2">
            <AccordionItem
              header="How long do we deliver your first blog post?"
